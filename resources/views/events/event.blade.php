        ...
        <div class="container">
            ...
            <ul class="nav justify-content-center nav-pills maintab-design" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="choose-destination-tab" data-bs-toggle="tab" data-bs-target="#choose-destination-tab-pane" type="button" role="tab" aria-controls="choose-destination-tab-pane" aria-selected="true">Choose Destination</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="request-book-tab" data-bs-toggle="tab" data-bs-target="#request-book-tab-pane" type="button" role="tab" aria-controls="request-book-tab-pane" aria-selected="false">Request to Book</button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="choose-destination-tab-pane" role="tabpanel" aria-labelledby="choose-destination-tab" tabindex="0">
                        ...
                        <div class="event-list-cont">
                            ...
                            <div class="event-list-inner">
                                <div class="event-timing">
                                    ...
                                    {{ Carbon\Carbon::parse($item->end_datetime)->format('F d, Y') }}
                                </div>
                                <a href="javascript:void(0)" class="event-name">{{ $item->location }}</a>

                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="TTF-lagoon-tab-pane" role="tabpanel" aria-labelledby="TTF-lagoon-tab" tabindex="0">
                                        <p>{!! Illuminate\Support\Str::words($item->description, 50) !!}</p>
                                        <a href="{{ url('event-detail', $item->slug) }}" class="success">View
                                            Details</a>
                                    </div>
                                </div>
                            </div>
                ...
                @endif
                <div class="tab-pane fade" id="request-book-tab-pane" role="tabpanel" aria-labelledby="request-book-tab" tabindex="0">
                        ...
                        <form id="eventRequest" class="ttf_form" action="{{ route('eventStore') }}" method="POST" autocomplete="off">
                            ...
                            <div class="step-first">
                                ...
                                <div class="mb-4">
                                    <label for="select-hotel-field" class="form-label">Select Hotel
                                        <sup>*</sup></label>
                                    <input type="text" class="form-control" id="select-hotel-field" name="hotel" value="The Trade Fair">
                                </div>
                                ...
                                <div class="mb-4">
                                    <label for="number-guest-field" class="form-label">Number of Guest
                                        <sup>*</sup></label>
                                    <input type="text" class="form-control phone" id="number-guest-field" name="guest_number">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div>
                                        <div class="form-check seating-style-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="Classroom" checked>
                                        ...
                                        <div class="form-check seating-style-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="Theatre">
                                        ...
                                        <div class="form-check seating-style-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="Sitdown">
                                        ...
                                        <div class="form-check seating-style-check">
                                            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios4" value="Cocktail">
                                ...
                                <div class="text-center mt-5">
                                    <button type="button" class="btn btn-primary next-btn" style="min-width:170px;">Next</button>
                                </div>
                            </div>
                            ...
                            <div class="step-second" style="display:none;">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="full-name-field" name="full_name">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="mb-3 input-group banquet-contact">
                                        ...
                                        <input type="text" name="phone" id="Phone-Number" minlength="10" maxlength="10" class="form-control phone" />
                                    </div>
                                    @if ($errors->has('phone'))
                                ...
                                <div class="text-center mt-5">
                                    <button type="submit" class="btn btn-primary" style="min-width:170px;">Submit</button>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
        ...
        $("#eventRequest").validate({
            ...
            submitHandler: function(form) {
                ...
                if (is_phone_verified == false || is_phone_verified == "false") {
