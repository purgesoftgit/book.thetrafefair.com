    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3">
                ...
                <!-- filter form start-->
                <div class="room_filter_block" id="roomFilterBlock"></div>
                <!-- filter form end-->
                            ...
                            <div class="dropdown share-drop">
                                ...
                                <div class="dropdown-menu dropdown-menu-end p-3 w-100">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u={{env('APP_URL')}}" target="_blank"><i class="fa fa-facebook"></i> Facebook</a>
                                        </li>
                                        <li><a href="https://twitter.com/intent/tweet?text={{env('APP_NAME')}}&url={{env('APP_URL')}}" target="_blank"><i class="fa fa-twitter"></i> X (formerly Twitter)</a>
                                        </li>
                                        <li><a href="https://www.linkedin.com/shareArticle?mini=true&url={{env('APP_URL')}}&title={{env('APP_NAME')}}" target="_blank"><i class="fa fa-linkedin"></i> LinkedIn</a></li>
                                        <li><a href="https://wa.me/?text={{env('APP_NAME')}}%20{{env('APP_URL')}}" target="_blank"><i class="fa fa-whatsapp"></i> Whatsapp</a></li>
                                    </ul>

                                </div>
                            </div>

                            <a href="#RoomReservation" class="btn btn-primary" type="button">Reserve</a>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 mt-5">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        ...
                        <h2 class="wedding_enquiry accordion-header" id="headingOne">
                        ...
                        <div id="collapseOne" class=" accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body headingOne">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="house-rules-sec" id="house-rules">
        ...
        <div class="bordshad-div house-rules-box fn-15">
            ...
            <div class="house-rules-list">
                ...
                <div class="house-rules-right">
                    <p>Cancellation and prepayment policies vary according to accommodation type. <a href="#roomFilterBlock" class="text-primary"><b>Please enter the dates of your stay</b></a> and check the conditions of your required room.</p>
                </div>
            </div>
