    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3">
                ...
                <!-- filter form start-->
                <div class="room_filter_block" id="room_filter_block"></div>
                <!-- filter form end-->
    ...
    <section class="house-rules-sec" id="house-rules">
        ...
        <div class="bordshad-div house-rules-box fn-15">
            ...
            <div class="house-rules-list">
                ...
                <div class="house-rules-right">
                    <p>Cancellation and prepayment policies vary according to accommodation type. <a href="#room_filter_block" class="text-primary"><b>Please enter the dates of your stay</b></a> and check the conditions of your required room.</p>
                </div>
            </div>
