<section class="reservation-form">
    <form id="bookNowfrom">
        @csrf
            ...
            <div class="row">
                <div class="mb-4 col-lg-12 col-md-6 col-sm-12">
            ...
            <div class="row justify-content-center">
                <div class="mb-4 col-lg-12 col-md-6 col-sm-6 d-grid">
                    <button type="button" class="btn btn-primary search-room">Check Availability</button>
                </div>
            </div>
    </form>
