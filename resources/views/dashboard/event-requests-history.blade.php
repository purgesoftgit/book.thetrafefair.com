                                ...
                                <tbody>
                                   ...
                                   <tr>
                                     ...
                                     <td style="vertical-align: top" >
                                       ...
                                       <span class="seating_style text-sucess">Theatre</span>
                                       @elseif($d->seating_style == "Classroom")
                                       <span class="seating_style text-sucess">Classroom</span>
                                       @elseif($d->seating_style == "Sitdown")
                                       <span class="seating_style text-sucess">Sitdown</span>
                                       @else
                                       <span class="seating_style text-sucess">Cocktail</span>
                                       @endif
                                     </td>
