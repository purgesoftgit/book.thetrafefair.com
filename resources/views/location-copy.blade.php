            ...
            <div class="tab-pane fade" id="review-tab-pane" role="tabpanel" aria-labelledby="review-tab" tabindex="0">
                ...
                <div class="space-div bdr-none">
                    ...
                    <div class="d-grid mt-5 mb-3">
                        ...
                        {{-- <button type="button" class="btn btn-primary write-review" id="write-review">Write a review</button> --}}
                    </div>
                    {{-- <div class="d-grid mt-5 mb-3">
      ...
      <div class="modal-content ">
        ...
        <div class="modal-body">
            ...
            <div class="review-list-top ">
              <div class="review-list-img"><img src="img/unnamed.png" alt="Image"></div>
              <div class="review-list-text">
                <div class="review-list-name" name="name">hira Lal kumhar</div>
            ...
            <div class="mb-3 d-grid">
              {{-- <button class="btn btn-primary">Add photos & videos</button> --}}
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.selecte-listing .selected-travel_with-listing .selecte-travel_with-list').click(function() {
            $(this).toggleClass("active");
            if ($(this).hasClass("active")) {
                travel.push($(this).text());
            } else {
                const index = travel.indexOf($(this).text());
                if (index > -1) { // only splice array when item is found
                    travel.splice(index, 1); // 2nd parameter means remove one item only
                }
            }
            $('.travel_with').val(travel)
        });

        $('.selecte-listing .selected-describe_hotel-listing .selecte-describe_hotel-list').click(function() {
            $(this).toggleClass("active");
            if ($(this).hasClass("active")) {
                describe_hotel.push($(this).text());
            } else {
                const index = describe_hotel.indexOf($(this).text());
                if (index > -1) { // only splice array when item is found
                    describe_hotel.splice(index, 1); // 2nd parameter means remove one item only
                }
            }
            $('.describe_hotel').val(describe_hotel)
        });

        $('.selecte-listing .selected_more_about_listing .selecte-more_about_list').click(function() {
            $(this).toggleClass("active");
            if ($(this).hasClass("active")) {
                more_about.push($(this).text());
            } else {
                const index = more_about.indexOf($(this).text());
                if (index > -1) { // only splice array when item is found
                    more_about.splice(index, 1); // 2nd parameter means remove one item only
                }
            }
            $('.more_about').val(more_about)
        });

        $('.selecte-listing .selected-kind_of_trip-listing .selecte-kind_of_trip-list').click(function() {
            $(this).toggleClass("active");
            if ($(this).hasClass("active")) {
                kind_of_trip.push($(this).text());
            } else {
                const index = kind_of_trip.indexOf($(this).text());
                if (index > -1) { // only splice array when item is found
                    kind_of_trip.splice(index, 1); // 2nd parameter means remove one item only
                }
            }
