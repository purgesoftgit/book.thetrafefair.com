          ...
          <div class="row">
            ...
            <div class="clearfix">&nbsp;</div>
                ...
                <div class="row pagetop-title">
                  <div class="col-lg-6 col-md-4 col-sm-4"><h3>NewsLetters</h3></div>
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td colspan="7"><h6 class="text-center">Newsletters not available.</h6></td>
                              </tr>
                              @else
                                ...
                                <tr>
                                  ...
                                  <td style="vertical-align: top" >{{$d->email}}</td>
