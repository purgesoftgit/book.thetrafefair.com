																				...
																				<td align="left" valign="top">
																					<table width="400px" border="0" cellspacing="0" cellpadding="0">
																						<tbody>
																							...
																							<tr>
																								<td style="color:#ffffff;font-size:14px;font-family:Arial,'sans-serif';line-height:20px;padding:15px 15px 0px 15px">In case you face issues with your check-in, contact us for immediate assistance and you may avail a free stay. To know more click here. <a href="{{env('TTF_URL').'contact-us'}}" style="text-decoration:underline;color:#ffffff" target="_blank" rel="noopener noreferrer"><strong>click here</strong></a>. <br>
																									<br>
														...
														<tbody>
															<tr>
																...
																<td style="text-align:right" width="120px">
																	<a href="https://maps.app.goo.gl/BD8RsfoKKnwet262A" target="_blank" rel="noopener noreferrer" style="color:#e9cc57;font-weight:600;font-size:14px;line-height:24px;font-family:Arial,'sans-serif'">Get directions</a>
																</td>
															</tr>
														</tbody>
													</table>
