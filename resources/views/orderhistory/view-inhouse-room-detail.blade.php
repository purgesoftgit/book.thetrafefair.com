...
?>
<h4 class="room-detail-title">User Detail Inhouse</h4>
...
<div class="room-detail-line">
  ...
  <span>{{date('d M, Y h:i A',strtotime($transaction_data->inperson_checkin_time ?? ''))}}</span>
</div>
<div class="room-detail-line">
  <strong>Checkout :</strong>
  <span>{{date('d M, Y',strtotime($checkoutdata['checkout'] ?? ''))}}</span>
</div>
<div class="room-detail-line">
...
<div class="room-detail-box purple-box">
  ...
  <div class="room-detail-line">
    <strong>Meal Total Amount :</strong>
    <span>₹{{$checkoutdata['subtotal_meal_amt']}}</span>
  </div>
  <div class="room-detail-line">
    <strong>Meal Tax :</strong>
    <span>₹{{$checkoutdata['subtotal_meal_tax']}}</span>
  </div>
  ...
  <div class="room-detail-line">
    <strong>Trade International Credit :</strong>
    <span>- {{$checkoutdata['subtotal_tti_credit']}} P</span>
  </div>
  <div class="room-detail-line">
    <strong>Reward Point :</strong>
    <span>- {{$checkoutdata['subtotal_tti_rewardpoint'] }} P</span>
  </div>
  <div class="room-detail-line">
  ...
  <div class="help-line">
   ...
   @else
      <p>(You have paid <b>{{ $checkoutdata['payment_option'] }}%</b> from your Total Amount. Now you will have to pay <b>₹<?php $remaining_amount  = (float)round($checkoutdata['grand_total_amt'] - $checkoutdata['f_total_amt'], 2); echo round($remaining_amount,2); ?> </b>)</p>
   @endif
  </div>
</div>
@endif
