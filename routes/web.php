...
Route::post('verify-login','PageController@verifyLogin');
Route::post('user-logout','PageController@userLogout');

Route::middleware(['auth'])->group(function () {
    Route::get('dashboard/{status?}', 'PageController@getRoomOrderHistory');
